<template>
  <div>
    ...
    <!-- <div> -->
      ...
      <!-- <button class="isUrgent-button"  @click="toggleUrgent">
      {{ my_price_list_label }}
    </button> -->
    <!-- <label>
  ...
  <!-- </div> -->
      <v-row align="center" class="items px-2 py-1">
        ...
        <v-col
          ...
          class="pb-2"
        >
          <Customer :readonly="manyItems" ></Customer>
        </v-col>
        <v-col
          cols="2"
          class="pb-2"
...
// 
  ...
  computed: {
    ...
    my_price_list_label(){
      return this.isUrgent ? this.urgent_label : this.default_label;
    },
    my_price_list() {
      return this.isUrgent ? this.urgent_price_list : this.standard_price_list;
    },
    // my_delivery_date(){
  ...
  methods: {
    ...
    get_invoice_doc() {
      ...
      this.pos_profile.selling_price_list = this.my_price_list;
      if (this.isUrgent){
...
.isUrgent-button {
  font-size: 18px;
  padding: 7px 12px;
  background-color: rgb(76, 172, 231); 
  color: white; 
  border: none; 
  border-radius: 10px;
  cursor: pointer; 
